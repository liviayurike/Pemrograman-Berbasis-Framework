...
let SignInForm = (props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="form">
      ...
      <div className="field">
        <div className="control">
          <Field // Komponen yang berfungsi sebagai cara untuk menghubungkan elemen
            name="lastName" // input dalam formulir ke logika redux-form.
            component={renderField}
            type="text"
            label="Last Name"
          />
...
// Membangun HOC dalam form redux
const renderField = ({
  input,
  label,
  type,
...
// Fungsi reduxForm () adalah komponen untuk mengambil objek konfiguras dan selalu mengembalikan fungsi baru.
// Mengkoneksikan Form ke redux form
